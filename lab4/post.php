...
$post = [
  [
    'id' => 1,
    'title' => 'The Road Ahead 1',
    'subtitle' => 'The road ahead might be paved - it might not be.',
    'img' => '/static/imgs/mainIng.png',
    'text' => '
      ...
      <section class="title">
        <div class="container">
          <div class="title-texts">
            <h1><?= $post[$_GET['id'] - 1]['title'] ?></h1>
            <?= $post[$_GET['id'] - 1]['id']?>
            <p><?= $post[$_GET['id'] - 1]['subtitle'] ?></p>
          </div>
        </div>
      </section>
      <div class="main-text">
        <div class="wide-container">
          <div class="main-img">
            <img src='<?= $post[$_GET['id'] - 1]['img'] ?>' alt="some img">
          </div>
        </div>
        <div class="container">
          <div class="main-text">
            <p><?= $post[$_GET['id'] - 1]['text'] ?></p>
          </div>
        </div>
      </div>
    </main>
