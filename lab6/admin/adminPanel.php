  ...
  <div class="container">
    <div class="header__inner">
      ...
      <div class="accout-elems">
        ...
        <form method="POST" action="http://localhost:8001/admin">
          <button class="exit-btn" type="submit">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H9" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M16 17L21 12L16 7" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M21 12H9" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </button>
        </form>
      </div>
    ...
    <div class="showIsPublish">
      <div class="container">
        ...
        <div class="from-correct">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 11.08V12C21.9988 14.1564 21.3005 16.2547 20.0093 17.9818C18.7182 19.709 16.9033 20.9725 14.8354 21.5839C12.7674 22.1953 10.5573 22.1219 8.53447 21.3746C6.51168 20.6273 4.78465 19.2461 3.61096 17.4371C2.43727 15.628 1.87979 13.4881 2.02168 11.3363C2.16356 9.18455 2.99721 7.13631 4.39828 5.49706C5.79935 3.85781 7.69279 2.71537 9.79619 2.24013C11.8996 1.7649 14.1003 1.98232 16.07 2.85999" stroke="#67C48C" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M22 4L12 14.01L9 11.01" stroke="#67C48C" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
              ...
              <div class="author-photos">
                ...
                <div class="authorPhoto__inner">
                  <div class="author-img">
                    ...
                    <svg class="none-author-img" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="container">
        <div class="textarea__inner">
          ...
          <div class="textarea-main">
            ...
            <textarea class="" name="Content" id="Content" cols="30" rows="10" placeholder="Type anything you want..."></textarea>
